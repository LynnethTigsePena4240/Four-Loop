...
public class InventoryController {
    ...
    public String addInventory(@ModelAttribute("product") Product product) {
        productService.addProduct(product);
        return "redirect:/inventory";
    }

    @PostMapping("/inventory/edit/{id}")
    public String updateInventory(@PathVariable int id, @ModelAttribute("product") Product product) {
